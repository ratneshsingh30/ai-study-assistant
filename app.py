...
def display_results():
    ...
    with quiz_tab:
        ...
        if st.session_state.quiz and st.session_state.quiz["success"]:
            quiz = st.session_state.quiz.get("quiz", {}).get("quiz", [])
    ...
    with export_tab:
        ...
        results = {
            ...
            "study_guide": st.session_state.study_guide.get("study_guide", {}).get("study_guide", {}) if st.session_state.study_guide else {},
            "quiz": st.session_state.quiz.get("quiz", {}).get("quiz", []) if st.session_state.quiz else []
        }
